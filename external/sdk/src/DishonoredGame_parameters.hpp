...
struct ADishonoredGameInfo_eventPreventDeath_Params
{
	...
	class UClass*                                      _pDamageType;                                     // 0x0008 (0x0004) [0x0000000000000080] (CPF_Parm)    
...
{
	class UClass*                                      _pSpawnClass;                                     // 0x0000 (0x0004) [0x0000000000000080] (CPF_Parm)    
	struct FVector                                     _SpawnLocation;                                   // 0x0004 (0x000C) [0x0000000000000080] (CPF_Parm)    
...
struct ADishonoredKActor_execTakeDamage_Native_Params
{
	...
	class UClass*                                      _pDamageType;                                     // 0x0020 (0x0004) [0x0000000000000080] (CPF_Parm)    
...
{
	class UClass*                                      _pDamageType;                                     // 0x0000 (0x0004) [0x0000000000000080] (CPF_Parm)    
};
...
struct ADishonoredPawn_eventFireTakeDamageKismetEvent_Params
{
	...
	class UClass*                                      _pInDamageType;                                   // 0x0004 (0x0004) [0x0000000000000080] (CPF_Parm)    
...
{
	class UClass*                                      _pItemClass;                                      // 0x0000 (0x0004) [0x0000000000000080] (CPF_Parm)    
...
{
	class UClass*                                      _pActionClass;                                    // 0x0000 (0x0004) [0x0000000000000080] (CPF_Parm)    
