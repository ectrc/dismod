...
enum ELoadFlags
{
	...
	LOAD_NoSeekFreeLinkerDetatch	= 0x00040000,	// Do not detatch linkers for this ` when seek-free loading
};
static const auto ELoadFlagsStringsMap = std::map<ELoadFlags, const char*>{
	    { LOAD_None, "LOAD_None" },
		{ LOAD_SeekFree, "LOAD_SeekFree" },
		{ LOAD_NoWarn, "LOAD_NoWarn" },
		{ LOAD_Throw, "LOAD_Throw" },
		{ LOAD_Verify, "LOAD_Verify" },
		{ LOAD_AllowDll, "LOAD_AllowDll" },
		{ LOAD_DisallowFiles, "LOAD_DisallowFiles" },
		{ LOAD_NoVerify, "LOAD_NoVerify" },
		{ LOAD_Quiet, "LOAD_Quiet" },
		{ LOAD_FindIfFail, "LOAD_FindIfFail" },
		{ LOAD_MemoryReader, "LOAD_MemoryReader" },
		{ LOAD_RemappedPackage, "LOAD_RemappedPackage" },
		{ LOAD_NoRedirects, "LOAD_NoRedirects" },
		{ LOAD_NoSeekFreeLinkerDetatch, "LOAD_NoSeekFreeLinkerDetatch" }
};
...
public:
	...
	typedef void (__thiscall *t)(UObject* object, UFunction* function, void* params, void* result);
	static inline auto pe = (t)(0x470640);
};
...
public:
	...
	uint8_t UnknownData00[0x12];// 0x008A (0x0016) DYNAMIC FIELD PADDING

  void(*exec)(void* context, void* stack, void* const result);
...
{
public:
	class UClass*                                      SupportedClass;                                // 0x0038 (0x0004) [0x0000000000000000]               
	class UClass*                                      ContextClass;                                  // 0x003C (0x0004) [0x0000000000000000]               
...
{
public:
	class UClass*                                      TemplateOwnerClass;                            // 0x0038 (0x0004) [0x0000000000001002] (CPF_Const | CPF_Native)
...
{
public:
	class FString                                      HelpDescription;                               // 0x0038 (0x000C) [0x0000000000408002] (CPF_Const | CPF_Localized | CPF_NeedCtorLink)
	class FString                                      HelpUsage;                                     // 0x0044 (0x000C) [0x0000000000408002] (CPF_Const | CPF_Localized | CPF_NeedCtorLink)
	class FString                                      HelpWebLink;                                   // 0x0050 (0x000C) [0x0000000000408002] (CPF_Const | CPF_Localized | CPF_NeedCtorLink)
