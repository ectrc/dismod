...
public:
	...
	class UClass*                                      NavigationHandleClass;                         // 0x0354 (0x0004) [0x0000000000002000] (CPF_Transient)
...
public:
	...
	void PlayDeath(class AController* Killer, const struct FVector& KillMomentum, class UClass* DamageType, class AActor* DamageCauser);
};
...
public:
	...
	class TArray<class UClass*>                        SupportedAgentClasses;                         // 0x0278 (0x000C) [0x0000000000400001] (CPF_Edit | CPF_NeedCtorLink)
	class TArray<class UObject*>                       SupportedArchetypes;                           // 0x0284 (0x000C) [0x0000000000400001] (CPF_Edit | CPF_NeedCtorLink)
	class TArray<class UClass*>                        RestrictedAgentClasses;                        // 0x0290 (0x000C) [0x0000000000400001] (CPF_Edit | CPF_NeedCtorLink)
...
public:
	...
	class UClass*                                      ThirdPersonCamDefaultClass;                    // 0x0094 (0x0004) [0x0000000000000001] (CPF_Edit)    
	...
	struct FVector                                     LastOffsetAdjustment;                          // 0x0168 (0x000C) [0x0000000000002000] (CPF_Transient | CPF_ProtectedWrite)
...
public:
	...
	class UClass*                                      ThirdPersonCameraClass;                        // 0x0414 (0x0004) [0x0000000000000003] (CPF_Edit | CPF_Const)
	class UGameCameraBase*                             FixedCam;                                      // 0x0418 (0x0004) [0x0000000004002001] (CPF_Edit | CPF_Transient | CPF_EditInline)
	class UClass*                                      FixedCameraClass;                              // 0x041C (0x0004) [0x0000000000000003] (CPF_Edit | CPF_Const)
...
{
public:
	class UClass*                                      PhysicalMaterialPropertyClass;                 // 0x0038 (0x0004) [0x0000000000000000]               
