...
{
	uint32_t                                           bBeingEdited : 1;                              // 0x0000 (0x0004) [0x0000000000002000] [0x00000001] (CPF_Transient | CPF_EditorOnly)
	float                                              PreviewPlayRate;                               // 0x0004 (0x0004) [0x0000000000000001] (CPF_Edit | CPF_EditorOnly)
	class USkeletalMesh*                               PreviewSkelMesh;                               // 0x0008 (0x0004) [0x0000000020000000]  CPF_Deprecated | CPF_EditorOnly)
	class USkeletalMesh*                               SocketSkelMesh;                                // 0x000C (0x0004) [0x0000000020000000]  CPF_Deprecated | CPF_EditorOnly)
	class UStaticMesh*                                 SocketStaticMesh;                              // 0x0010 (0x0004) [0x0000000020000000]  CPF_Deprecated | CPF_EditorOnly)
	class FName                                        SocketName;                                    // 0x0014 (0x0008) [0x0000000020000000]  CPF_Deprecated | CPF_EditorOnly)
	class TArray<class UAnimSet*>                      PreviewAnimSets;                               // 0x001C (0x000C) [0x0000000020400000] (CPF_NeedCtorLink | CPF_Deprecated | CPF_EditorOnly)
	class TArray<struct FPreviewSkelMeshStruct>        PreviewMeshList;                               // 0x0028 (0x000C) [0x0000000000400001] (CPF_Edit | CPF_NeedCtorLink | CPF_EditorOnly)
	int32_t                                            PreviewMeshIndex;                              // 0x0034 (0x0004) [0x0000000000000000] (CPF_EditorOnly)
	class TArray<struct FPreviewSocketStruct>          PreviewSocketList;                             // 0x0038 (0x000C) [0x0000000000400001] (CPF_Edit | CPF_NeedCtorLink | CPF_EditorOnly)
	int32_t                                            PreviewSocketIndex;                            // 0x0044 (0x0004) [0x0000000000000000] (CPF_EditorOnly)
	class TArray<struct FPreviewAnimSetsStruct>        PreviewAnimSetList;                            // 0x0048 (0x000C) [0x0000000000400001] (CPF_Edit | CPF_NeedCtorLink | CPF_EditorOnly)
	int32_t                                            PreviewAnimSetListIndex;                       // 0x0054 (0x0004) [0x0000000000000000] (CPF_EditorOnly)
	int32_t                                            PreviewAnimSetIndex;                           // 0x0058 (0x0004) [0x0000000000000000] (CPF_EditorOnly)
	struct FVector                                     PreviewCamPos;                                 // 0x005C (0x000C) [0x0000000000000000] (CPF_EditorOnly)
	struct FRotator                                    PreviewCamRot;                                 // 0x0068 (0x000C) [0x0000000000000000] (CPF_EditorOnly)
	struct FVector                                     PreviewFloorPos;                               // 0x0074 (0x000C) [0x0000000000000000] (CPF_EditorOnly)
	int32_t                                            PreviewFloorYaw;                               // 0x0080 (0x0004) [0x0000000000000000] (CPF_EditorOnly)
	class UAnimNode*                                   m_pEditorPreviewNode;                          // 0x0084 (0x0004) [0x0000000000002000] (CPF_Transient | CPF_EditorOnly)
};
...
struct FArkPpColorBalanceParameters
{
	...
	float                                              m_Opacity;                                     // 0x0028 (0x0004) [0x0000000000000001] (CPF_Edit | CPF_Interp)
	float                                              m_PreDesaturation;                             // 0x002C (0x0004) [0x0000000000000001] (CPF_Edit | CPF_Interp)
	float                                              m_PostDesaturation;                            // 0x0030 (0x0004) [0x0000000000000001] (CPF_Edit | CPF_Interp)
};
...
struct FArkPpBloomParameters
{
	...
	struct FLinearColor                                m_Tint;                                        // 0x0004 (0x0010) [0x0000000000000001] (CPF_Edit | CPF_Interp)
...
struct FEditorMatineeData
{
	...
	class TArray<class UInterpFilter*>                 InterpFilters;                                 // 0x0004 (0x000C) [0x0000000000420001] (CPF_Edit | CPF_EditConst | CPF_NeedCtorLink | CPF_EditorOnly)
	class UInterpFilter*                               SelectedFilter;                                // 0x0010 (0x0004) [0x0000000000020001] (CPF_Edit | CPF_EditConst | CPF_EditorOnly)
	class TArray<class UInterpFilter*>                 DefaultFilters;                                // 0x0014 (0x000C) [0x0000000000422001] (CPF_Edit | CPF_Transient | CPF_EditConst | CPF_NeedCtorLink | CPF_EditorOnly)
	float                                              EdSectionStart;                                // 0x0020 (0x0004) [0x0000000000020001] (CPF_Edit | CPF_EditConst | CPF_EditorOnly)
	float                                              EdSectionEnd;                                  // 0x0024 (0x0004) [0x0000000000020001] (CPF_Edit | CPF_EditConst | CPF_EditorOnly)
};
...
{
	class UPhysicsAsset*                               BoundsPreviewAsset;                            // 0x0000 (0x0004) [0x0000000000000001] (CPF_Edit | CPF_EditorOnly)
	class FString                                      SourceFilePath;                                // 0x0004 (0x000C) [0x0000000000420003] (CPF_Edit | CPF_Const | CPF_EditConst | CPF_NeedCtorLink | CPF_EditorOnly)
	class FString                                      SourceFileTimestamp;                           // 0x0010 (0x000C) [0x0000000000420003] (CPF_Edit | CPF_Const | CPF_EditConst | CPF_NeedCtorLink | CPF_EditorOnly)
};
...
{
	class USkeletalMesh*                               PreviewSkelMesh;                               // 0x0000 (0x0004) [0x0000000000000001] (CPF_Edit | CPF_EditorOnly)
	class USkeletalMeshComponent*                      PreviewSkelComp;                               // 0x0004 (0x0004) [0x00000000040A200B] (CPF_Edit | CPF_Const | CPF_ExportObject | CPF_Transient | CPF_EditConst | CPF_Component | CPF_EditInline | CPF_EditorOnly)
	class UStaticMesh*                                 PreviewStaticMesh;                             // 0x0008 (0x0004) [0x0000000000000001] (CPF_Edit | CPF_EditorOnly)
};
