...
auto __cdecl UObject_LoadPackage_hook::trampoline(UPackage* in, const wchar_t* file_name, ELoadFlags load_flags) -> UPackage* {
  ...
  LOG("LoadPackage({}, {})", in != nullptr ? in->GetPackageName().ToString() : "nullptr", file_name_str);
