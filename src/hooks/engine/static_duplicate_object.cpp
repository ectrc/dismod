...
auto __cdecl UObject_StaticDuplicateObject_hook::trampoline(UObject *SourceObject, UObject *RootObject, UObject *DestOuter, const wchar_t *DestName, unsigned __int64 FlagMask, UClass *DestClass, unsigned int bMigrateArchetypes) -> UObject* {
#if LOG_SDO
